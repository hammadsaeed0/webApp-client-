...
export default function CoverLetter35({
  showProtip,
  readOnly,
  chosenCategory,
  sidePanelTextColor,
        ...
        >
          <div>
            ...
            <div>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].headLine}
                setEditorData={dataUpdatableLeft[0].setHeadLine}
              />
            </div>
          </div>
          <div
          ...
          >
            <BuilderEditor
              readOnly={readOnly}
              content={dataUpdatableLeft[0].nameChar}
              setEditorData={dataUpdatableLeft[0].setNameChar}
            />
          </div>
        </div>
        <div>
