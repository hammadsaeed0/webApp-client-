                    ...
                    >
                      ...
                      <div>
                        <BuilderEditor readOnly={readOnly}
                          key={index + 1}
                          content={descp.heading} setEditorData={descp.setDeading}
                        />
                      </div>
                    </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
            ...
            <div style={{ display: page === 1 ? null : 'none' }}>
              ...
              />
                  ...
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].name} setEditorData={dataUpdatableLeft[0].setName} />
                </div>
                <div>
              ...
              <div style={{ padding: '1rem 1rem 0' }}>
                <div>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].description} setEditorData={dataUpdatableLeft[0].setDescription} />
                </div>
              </div>
            </div>
            ...
            <div style={{ width: '70%' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      {dataUpdatableLeft[1].type === 'personal' ? (
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          height='24px'
                          viewBox='0 0 24 24'
                  ...
                  <div style={{ width: '20%', border: '1px solid', }} ></div>
                </div>
              </div>
              <div
                className={`description ${bodyTextStyleConditions} 
                ${ documentBodyTextSize === 'Very Small' ? 'body_verySmall' : documentBodyTextSize === 'Small' ? 'body_small' : documentBodyTextSize === 'Medium' ? 'body_medium' : documentBodyTextSize === 'Large' ? 'body_large' : null } `} 
                style={{ color: sidePanelTextColor }}
              >
                <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[1].description} setEditorData={dataUpdatableLeft[1].setDescription} />
              </div>
            </div>

          </div>
          <div style={{ padding: '1rem 1rem 0' }} ref={rightMainRef} className='blankTemplate_profile section'>
          <div className='blankTemplate_header section '>
