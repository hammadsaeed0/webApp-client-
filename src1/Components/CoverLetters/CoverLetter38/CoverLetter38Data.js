...
export default function COVERLETTER38DATA() {
...
const [position, setPosition] = useState({
  blocks: [
    {
      key: '637gr',
      text: '1 AWylozc Road, Anywhere 98760 07700 900 532 \nrickywoolf@example.com',
      type: 'unstyled',
      depth: 0,
      inlineStyleRanges: [
        {
...
const CoverLetter38Data = {
  position, setName,
  profileDescp, setPosition,
  name, setProfileDescp,
  personal_info_descp, setPersonal_info_descp,
  enterName, setEnterName,
  lorealIpsum, setLorealIpsum,
};

  return { CoverLetter38Data };
}