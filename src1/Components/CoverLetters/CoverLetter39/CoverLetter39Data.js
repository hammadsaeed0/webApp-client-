...
export default function COVERLETTER39DATA() {
  ...
  const [position, setPosition] = useState({
    blocks: [
      {
        key: '637gr',
        text: 'Anyold Road, Anfield, London AN6 3RE; \n07700 900 595 | brianmcgee@gmail.com',
        type: 'unstyled',
        depth: 0,
        inlineStyleRanges: [
          {
