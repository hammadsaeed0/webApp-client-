  ...
  return (
    <div className='blankTemplate_page'>
      <div
        ...
        style={{ width: '3%', padding: '0mm', margin: '0rem', minHeight: '29.7cm' }}
      >
        <div
          style={{
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start'  }}>
          ...
          <span>
              ...
              <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].heading} />
          </div>

          <div style={{}} className={` section`}>
              <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[1].description} />
          </div>
        </div>
        <div className='blankTemplate_header section '>
