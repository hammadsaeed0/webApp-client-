...
export default function CoverLetter11({
  showProtip,
  readOnly,
  chosenCategory,
  sidePanelTextColor,
  ...
  return (
    <div className='blankTemplate_page'>
      <div
        ...
        style={{ padding: '0mm', margin: '0rem', minHeight: '29.7cm' }}
      >
        <div
          style={{
      ...
      >
        ...
        {/* <BuilderEditor readOnly={readOnly} content={dataUpdatableRight[0].description[0].description} /> */}
