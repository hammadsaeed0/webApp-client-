...
CoverLetterDocument({ isSubscriptionExpired, loginPopup, loginPopupBG, userLoggedIn, userData, readOnly, coverLetterId, initialDocumentName, saveCoverLetterData, pageDocumentData, document_name, setDocument_name, chosenCategory, setChosenCategory, chosenDesign, setChosenDesign, addSectionModal, addSectionModalBG, pageBorderColor, pageBorderWidth, pageBorderStyle, borderedPage, headingTextStyleConditions, bodyTextStyleConditions, headingTextSizeConditions, bodyTextSizeConditions, mainPanelBgColor, sidePanelTextColor, sidePanelBgColor, pageUpdatableData, pageLayout, lineHeight, docummentMargin, docummentDateFormat, documentHeadingTextStyle, documentBodyTextStyle, documentBodyTextSize, }) {
    ...
    coverLetterId
      ...
      : create_cover_letter(saveCoverLetterData, config).then((res) => {
          if (res?.status === 200 || res?.status === 304) {
            ...
            setLoading(false);
            setShowSaveToast(true); 
            !isSubscriptionExpired && history.push(`/CoverLetter/${chosenCategory}/${chosenDesign}/${res?.data.id}`);
            localStorage.setItem(
              'downloadData',
              JSON.stringify({
                type: 'CoverLetter', 
  ...
  const savePageDataandShare = () => {
    ...
    console.log(coverLetterId ? 'Updating it ' : 'Creating New');
    coverLetterId
      ? handleShowShareDialog('https://cvjury.app/CoverLetter_view/' + chosenCategory + '/' + chosenDesign + '/' + coverLetterId + '/share') // share_Modal('https://cvjury.app/CoverLetter_view/' + chosenCategory + '/' + chosenDesign + '/' + coverLetterId + '/share')
      : create_cover_letter(saveCoverLetterData, config).then((res) => {
          if (res?.status === 200 || res?.status === 304) {
            setLoading(false);
            setShowToastText('Saved Successfully!');
            ...
            handleShowShareDialog('https://cvjury.app/CoverLetter_view/' + chosenCategory + '/' + chosenDesign + '/' + res?.data.id + '/share') 
            // share_Modal('https://cvjury.app/CoverLetter_view/' + chosenCategory + '/' + chosenDesign + '/' + res?.data.id + '/share');
          } else {
            console.log(res?.includes(saveCoverLetterData.documentName));
            if (res?.includes(saveCoverLetterData.documentName)) {
              setShowToastText(
                ...
                >
                  ...
                  >
                    {pageData.design === 'blankTemplate' ? (
                      ...
                      <CoverLetter1 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_2' ? (
                      <CoverLetter2 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_3' ? (
                      <CoverLetter3 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_4' ? (
                      <CoverLetter4 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_5' ? (
                      <CoverLetter5 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_6' ? (
                      <CoverLetter6 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_7' ? (
                      <CoverLetter7 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_8' ? (
                      <CoverLetter8 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_9' ? (
                      <CoverLetter9 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_10' ? (
                      <CoverLetter10 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_11' ? (
                      <CoverLetter11 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_12' ? (
                      <CoverLetter12 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_13' ? (
                      <CoverLetter13 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_14' ? (
                      <CoverLetter14 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_15' ? (
                      <CoverLetter15 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_16' ? (
                      <CoverLetter16 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_17' ? (
                      <CoverLetter17 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_18' ? (
                      <CoverLetter18 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_19' ? (
                      <CoverLetter19 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_20' ? (
                      <CoverLetter20 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_21' ? (
                      <CoverLetter21 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_22' ? (
                      <CoverLetter22 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_23' ? (
                      <CoverLetter23 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_24' ? (
                      <CoverLetter24 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_25' ? (
                      <CoverLetter25 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_26' ? (
                      <CoverLetter26 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_27' ? (
                      <CoverLetter27 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_28' ? (
                      <CoverLetter28 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_29' ? (
                      <CoverLetter29 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_30' ? (
                      <CoverLetter30 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_31' ? (
                      <CoverLetter31 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_32' ? (
                      <CoverLetter32 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_33' ? (
                      <CoverLetter33 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_34' ? (
                      <CoverLetter34 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_35' ? (
                      <CoverLetter35 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_36' ? (
                      <CoverLetter36 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_37' ? (
                      <CoverLetter37 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_38' ? (
                      <CoverLetter38 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_39' ? (
                      <CoverLetter39 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : pageData.design === 'design_40' ? (
                      <CoverLetter40 showProtip={showProtip} readOnly={readOnly} chosenCategory={chosenCategory} headingTextStyleConditions={headingTextStyleConditions} bodyTextStyleConditions={bodyTextStyleConditions} headingTextSizeConditions={headingTextSizeConditions} bodyTextSizeConditions={bodyTextSizeConditions} mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} page={1} rightMainRef={pageData.rightMainRef} setDataUpdatableLeft={pageData.setDataUpdatableLeft} dataUpdatableLeft={pageData.dataUpdatableLeft} dataUpdatableRight={pageData.dataUpdatableRight} setDataUpdatableRight={pageData.setDataUpdatableRight} docummentMargin={docummentMargin} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> // prettier-ignore
                    ) : null}
  ...
  return (
    <form onSubmit={(e) => {e.preventDefault();savePageData();}} className='builder_main'>
      ...
      <div className={`document_name_section `}>
        ...
        <p className='document_date ' style={{ display: 'flex',
        ...
        <div style={{ display: 'flex', gap: '10px', }}>
          ProTips
        <label class="switch">
          <input type="checkbox" checked={showProtip}  onChange={(e) => setShowProtip(e.target.checked)} />
