...
const Template5 = ({
        ...
        <>
          {
            <div key={data.key} ref={data.ref} className={data.class}>
              ...
              <div className='section'>
                ...
                >
                  ...
                  <div style={{ width: '80%' }}>
                    <div
                      style={{
                        display:
                          index === 0 ? 'none' : index === 1 ? 'none' : 'block',
                      }}
                ...
                {data.description ===
                'none' ? null : data.header ? null : data.subSection ? (
                  data.description.map((descp, index) => (
                    ...
                    >
                      ...
                      <div
                        key={index + 1}
                        className={`template_5_description_with_subsection 
                                    ${bodyTextStyleConditions}
                        ...
                        >
                          ...
                          >
                            ...
                            <div style={{ marginLeft: '3px' }}>
                              <div className='template_5_software_level'>
                                  ...
                                  style={{
                                    background:
                                      descp.expertice >= 20
                                        ? sidePanelTextColor
                                        : null,
                                    border: `1px solid ${sidePanelTextColor}`,
                                  }}
                                  onClick={(e) => {
                  ...
                  data.description.map((descp, index) => (
                    <div key={descp.key} className='template_1_subSection '>
                      <div className='subsectionCopyDelIconWrapper'>
                        <span
                          title='Delete Sub Section'
                          onClick={(e) => {
  ...
  return (
    <div className='Template_5_page'>
      <div
        style={{ background: sidePanelBgColor }}
        className='Template_5_header'
      >
        <div style={{ display: page === 1 ? null : 'none' }}>
          ...
          <div className='Template_5_header_description'>
            {dataUpdatableRight[0].description.map((headerItems) => (
              <div
                style={{
                  display: 'flex',
              ...
              >
                ...
                <BuilderEditor
                  readOnly={readOnly}
                  content={headerItems.data}
                  setEditorData={headerItems.setData}
                />
              </div>
            ))}
          </div>
