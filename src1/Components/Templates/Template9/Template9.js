...
const Template9 = ({
  ...
  // // // console.log(page)
  // // console.log('From Template 2', dataUpdatableLeft);
  // // console.log('From Template 2', dataUpdatableRight);
              ...
              <div className='section'>
                ...
                {data.header ? null : data.description ===
                  ...
                  data.description.map((descp, index) => (
                    ...
                    >
                      ...
                      <div
                        key={index + 1}
                        className={`template_2_description_with_subsection description ${bodyTextStyleConditions} ${bodyTextSizeConditions} `}
                        style={{ color: sidePanelTextColor }}
                      >
                        <div>
                          <div
                          ...
                          >
                            ...
                            <div
                              style={{ borderTop: '1px solid', width: '35%' }}
                            ></div>
                  ...
                  <div>
                    {data.description.map((descp, index) => (
                      ...
                      >
                        ...
                        <div
                          key={index + 1}
                          className={`template_4_description ${bodyTextStyleConditions} ${bodyTextSizeConditions} `}
                          style={{
                          ...
                          <div style={{ marginLeft: '3px' }}>
                            <div className='template_4_language_level'>
                              ...
                              {descp.expertice >= 20 ? (
                                <svg
                                  onClick={(e) => {
                                    setProgressExpertise(e, descp, 20);
                                    dataOnRight();
                                    setTemp(index + 1);
                                  }}
                                  xmlns='http://www.w3.org/2000/svg'
                              ...
                              {descp.expertice >= 40 ? (
                                <svg
                                  onClick={(e) => {
                                    setProgressExpertise(e, descp, 40);
                                    dataOnRight();
                                    setTemp(index + 1);
                                  }}
                                  xmlns='http://www.w3.org/2000/svg'
                              ...
                              {descp.expertice >= 60 ? (
                                <svg
                                  onClick={(e) => {
                                    setProgressExpertise(e, descp, 60);
                                    dataOnRight();
                                    setTemp(index + 1);
                                  }}
                                  xmlns='http://www.w3.org/2000/svg'
                              ...
                              {descp.expertice >= 80 ? (
                                <svg
                                  onClick={(e) => {
                                    setProgressExpertise(e, descp, 80);
                                    dataOnRight();
                                    setTemp(index + 1);
                                  }}
                                  xmlns='http://www.w3.org/2000/svg'
                              ...
                              {descp.expertice >= 100 ? (
                                <svg
                                  onClick={(e) => {
                                    setProgressExpertise(e, descp, 100);
                                    dataOnRight();
                                    setTemp(index + 1);
                                  }}
                                  xmlns='http://www.w3.org/2000/svg'
                  ...
                  <div
                    key={index + 1}
                    className={`template_2_description description ${bodyTextStyleConditions} ${bodyTextSizeConditions} `}
                    style={{ color: sidePanelTextColor }}
                  >
                    {/* <div> */}
                    <BuilderEditor
                ...
                data.type === 'certifications' ? (
                  ...
                  data.description.map((descp, index) => (
                    ...
                    >
                      <div style={{ width: '30%', margin: '0 1rem' }}></div>
  ...
  return (
    <div className='blankTemplate_page'>
      {/* <div style={{background: sidePanelBgColor}} className={`Template_3_sidebar ${docummentMargin === 'Compact' ? 'sidebar_compact' : docummentMargin === 'Narrow' ? 'sidebar_narrow' :  docummentMargin === 'Normal' ? 'sidebar_normal':  docummentMargin === 'Wide' ? 'sidebar_wide' :   docummentMargin === 'Broad' ? 'sidebar_broad' : null}`}>
      ...
      >
        ...
        >
          <div>
            <div>
              ...
              >
                ...
                <BuilderEditor
                  readOnly={readOnly}
                  key='4534'
                  content={dataUpdatableRight[0].heading[0].name}
                  setEditorData={dataUpdatableRight[0].heading[0].setName}
                />
              </div>
            </div>
            ...
            <div>
              <BuilderEditor
                readOnly={readOnly}
                key='4534'
                content={dataUpdatableRight[0].heading[0].position}
                setEditorData={dataUpdatableRight[0].heading[0].setPosition}
              />
            </div>
          </div>
          <div
          ...
          >
            {dataUpdatableRight[0].contacts.map((data, index) => (
              <div
                key={index}
                style={{
                  width: '40%',
