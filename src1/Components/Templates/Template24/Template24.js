        ...
        <>
          {
            <div key={data.key} ref={data.ref} className={data.class}>
              ...
              <div className='section'>
                ...
                {/* <div style={{ width: '100%', marginBottom: '1rem', borderColor: '#31292B' }} className='Template_4_divider_main'></div> */}
                      ...
                      >
                        ...
                        >
                          <div
                            style={{
                              display:
                                data.type === 'education' ? 'flex' : 'block',
                          ...
                          >
                            <div
                              style={{
                                width: data.type === 'education' ? '35%' : null,
                              }}
                            >
                              <BuilderEditor
                                readOnly={readOnly}
                            ...
                            <div
                              style={{
                                width: data.type === 'education' ? '65%' : null,
                              }}
                            >
                              <BuilderEditor
                                readOnly={readOnly}
        ...
        <>
          ...
          >
            ...
            <div className='sidebar_section '>
              ...
              {/* <div style={{ width: '100%', marginBottom: '1rem', borderColor: '#31292B' }} className={'Template_4_divider_sidebar'}></div> */}
