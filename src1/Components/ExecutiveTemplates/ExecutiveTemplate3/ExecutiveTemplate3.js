...
const ExecutiveTemplate3 = ({
        ...
        <>
          {
            ...
            >
              ...
              <div className='section'>
                ...
                {/* <div style={{ width: '100%', }} className='Template_4_divider_main'></div> */}
                ...
                {data.header ? null : data.description ===
                  ...
                  data.description.map((descp, index) => (
                    ...
                    >
                      ...
                      <div
                        key={index + 1}
                        className={`template_2_description_with_subsection 
                                    ${bodyTextStyleConditions}
                  ...
                  <div style={{ background: mainPanelBgColor }}>
                    <div>
                      {data.description_1.map((descp, index) => (
                        <div
                          key={descp.key}
                          className='template_1_subSection section'
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex = data.description_1.findIndex(
                                  (e) => e.key === descp.key
                                );
                                delete_subsection_Modal(
                                  data.description_1,
                    ...
                    >
                      <div style={{ width: '75%' }}>
                        {data.description_2.map((descp, index) => (
                          <div
                            key={descp.key}
                            className='template_1_subSection section'
                          >
                        ...
                        >
                          <div>
                            <BuilderEditor
                              readOnly={readOnly}
                              key={index + 1}
                              content={data.description_3_heading}
                              setEditorData={data.setDescription_3_heading}
                            />
                          </div>
                        </div>

                        {/* Description */}
                        {data.description_3.map((descp, index) => (
                          <div
                            key={descp.key}
                            className='template_1_subSection section'
                          >
                    ...
                    {data.description.map((descp, index) => (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{ color: sidePanelTextColor }}
                        >
                          {/* <div style={{ display: 'block', justifyContent: 'space-between', alignItems: 'start', width: '100%' }} className=''> */}
                          <div>
                            <BuilderEditor
                              readOnly={readOnly}
                              content={descp.description}
                  ...
                  <div>
                    ...
                    <div style={{ background: mainPanelBgColor }}>
                      {data.section_description.map((descp, index) => (
                        <div
                          key={descp.key}
                          className='template_1_subSection section'
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex =
                                  data.section_description.findIndex(
                                    (e) => e.key === descp.key
                                  );
                                delete_subsection_Modal(
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            ...
                            onClick={() =>
                              changeExperticeModal(data.description)
                            }
                          >
                            {/* <BuilderEditor readOnly={readOnly} content={data.description} /> */}

                            {/* <div style={{cursor: 'pointer'}} onClick={() => changeExperticeModal(data.expertice)} className='progressBarContainer'> */}
                            <div
                              style={{
                                cursor: 'pointer',
                                backgroundColor: mainPanelBgColor,
                                height: '8px',
                                width: '250px',
                              }}
                  ...
                  >
                    ...
                    <div style={{ width: '27%' }}>
                      {/* {data.keyImpact.map((descp, index) => (  */}
                      <div
                        style={{
                          marginBottom: '5px',
                          padding: '8px',
                      ...
                      >
                        <div
                          key={index + 1}
                          className={`template_2_description_with_subsection ${bodyTextStyleConditions} ${bodyTextSizeConditions} `}
                          style={{}}
                        >
                          <div
                            style={{
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={data.chart_heading}
                                setEditorData={data.setChart_heading}
                              />
                            </div>
                            <div
                              style={{
                            ...
                            >
                              ...
                              >
                                ...
                                <div contentEditable='true'>60</div>
                              ...
                              >
                                <div contentEditable='true'>2013</div>
                                <div contentEditable='true'>2014</div>
                                <div contentEditable='true'>2015</div>
                                <div contentEditable='true'>2016</div>
                                <div contentEditable='true'>2017</div>
                              </div>
                              <div
                                style={{
                                  position: 'absolute',
                              ...
                              <div className='template_1_subSection section'>
                                <div
                                  style={{
                                    display: 'flex',
                                    gap: '1.3rem',
                                ...
                                >
                                  {data.revenue.map((descp, index) => (
                                    <div
                                      onClick={() =>
                                        changeExperticeModal(data.revenue)
                                      }
                                      style={{
                                        cursor: 'pointer',
                                        height: '130px',
                                  ...
                                  {/* <div style={{cursor: 'pointer', height: '130px', width: '10px', display: 'flex', justifyContent: 'center', alignItems: 'end', }} className='progressBarContainer_template_4'>
                                                                    <div style={{ height: '20%', width: '10px',  backgroundColor: sidePanelBgColor }} className='progressBarCompleted'> </div>
                                                                </div>
                                                                <div style={{cursor: 'pointer', height: '130px', width: '10px', display: 'flex', justifyContent: 'center', alignItems: 'end', }} className='progressBarContainer_template_4'>
                                                                    <div style={{ height: '40%', width: '10px',  backgroundColor: sidePanelBgColor }} className='progressBarCompleted'> </div>
                                                                </div>
                                                                <div style={{cursor: 'pointer', height: '130px', width: '10px', display: 'flex', justifyContent: 'center', alignItems: 'end', }} className='progressBarContainer_template_4'>
                                                                    <div style={{ height: '60%', width: '10px',  backgroundColor: sidePanelBgColor }} className='progressBarCompleted'> </div>
                                                                </div>
                                                                <div style={{cursor: 'pointer', height: '130px', width: '10px', display: 'flex', justifyContent: 'center', alignItems: 'end', }} className='progressBarContainer_template_4'>
                                                                    <div style={{ height: '80%', width: '10px',  backgroundColor: sidePanelBgColor }} className='progressBarCompleted'> </div>
                                                                </div>
                                                                <div style={{cursor: 'pointer', height: '130px', width: '10px', display: 'flex', justifyContent: 'center', alignItems: 'end', }} className='progressBarContainer_template_4'>
                                                                    <div style={{ height: '100%', width: '10px',  backgroundColor: sidePanelBgColor }} className='progressBarCompleted'> </div>
                                                                </div> */}
                                </div>
                              </div>
                            </div>
  ...
  return (
    <div style={{ paddding: '0 1rem' }} className='template_4_page'>
      <div
        style={{
      ...
      >
        ...
        >
          <div>
            <div style={{ color: sidePanelBgColor }}>
              <div
                style={{
                  display: 'flex',
                  justifyContent: 'start',
                ...
                {dataUpdatableRight[0].name && (
                  <svg
                    ...
                    onClick={() =>
                      proTips_Modal(
                        dataUpdatableRight[0].name &&
                          BuilderProtip(dataUpdatableRight[0].name)
          ...
          <div>
            <BuilderEditor
              readOnly={readOnly}
              content={dataUpdatableRight[0].contact}
              setEditorData={dataUpdatableRight[0].setContact}
            />
          </div>
        </div>
      </div>
      <div className='template_4_hero_section'>
        <div
          style={{ paddingTop: '1rem', width: '100%', position: 'relative' }}
...
export default ExecutiveTemplate3;
