...
const ExecutiveTemplate1 = ({
        ...
        <>
          {
            ...
            >
              ...
              <div
                style={{ left: '40px', top: '-20px', flexDirection: 'row' }}
              ...
              <div
                ...
                style={{
                  ...
                  alignItems: 'inherit',
                  gap: '1rem',
                  borderLeft: `1px solid ${mainPanelBgColor}`,
                }}
              >
                <div
                  style={{
                    ...
                    borderTop: `10px solid ${sidePanelBgColor}`,
                    borderBottom: `10px solid ${sidePanelBgColor}`,
                    display: 'flex',
  ...
  return (
    <div className='template_4_page'>
      <div
        style={{ padding: '0 1.5rem', background: mainPanelBgColor }}
        className='section'
      >
        <div
          className='section'
        ...
        >
          <div>
            <BuilderEditor
              readOnly={readOnly}
              content={dataUpdatableRight[0].subPosition}
              setEditorData={dataUpdatableRight[0].setSubPosition}
            />
          </div>
          <div>
            <div
      ...
      <div className='template_4_hero_section'>
        <div
          style={{ paddingTop: '0', width: '100%', position: 'relative' }}
          className={`Template_4_main `}
        >
          <div
            style={{ paddingLeft: '0rem', paddingRight: '2rem' }}
            ref={rightMainRef}
...
export default ExecutiveTemplate1;
