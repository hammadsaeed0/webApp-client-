...
import CoverLetterDocument from '../../../Components/CoverLetterDocument/CoverLetterDocument';
...
export default function CoverLetter({
  ...
  const { category, design, coverLetterId } = useParams();
  ...
  useEffect(() => {
    !coverLetterId && setCoverLetterUpdatableData(
      pageDataSelector && { ...designDataSelector, ...pageDataSelector }
    );
    coverLetterId &&
      setCategoryUpdatableData(
                     ...
                     if (type === 'category'){
                      ...
                      setChosenDesign(template);
                        setPageUpdatableData(null);
                          history.push(`/CoverLetter/${chosenCategory}/${template}`)
                     }
                      onClose()
                    }}
                    className='login_modal_secondary_btn'
  ...
  return (
    <div className='builder'>
      ...
      <div style={{ overflowX: 'hidden' }}>
              ...
              {chooseDesignData
                ...
                .map((choose_template) => (
                  <div
                    onClick={
                      (e) =>
                        // go_to_another_page_Modal(choose_template.name,'design',chosenCategory)
                        go_to_another_page_Modal_old(
                          chosenCategory,
                          choose_template.name
                        )
                      // setChosenDesign(choose_template.name)
                    }
                  ...
                  >
                    <img
                      ...
                      className={
                        chosenDesign === choose_template.name
                          ? 'template_selected'
                          : null
                      }
        ...
        {/* {updateCoverLetterDocument()} */}
        {/* <CoverLetterDocument mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} pageUpdatableData={pageUpdatableData} pageLayout={pageLayout} lineHeight={lineHeight} docummentMargin={docummentMargin} docummentDateFormat={docummentDateFormat} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> */}
      </div>
      <div style={{ overflowX: 'hidden' }}>
        <div
        ...
        ></div>
        <div
          className={`change_template_sidebar_cover_letter category_change_template_sidebar_cover_letter   ${
        ...
        >
          ...
          >
            ...
            >
              <Dropdown
                className='dropdown dropdown_chooseTemplate change_template_sidebar_dropdown_setting  sidebar_category_dropdown_chooseTemplate'
                options={dropdownOptions}
                value={defaultDropdownOption}
                onChange={(e) => setFilterResume(e.value)}
                placeholder='Select an option'
                ...
                .map((choose_template) => (
                  <div
                    onClick={
                      ...
                      // setChosenCategory(choose_template.name)
                    }
                    className={`sidebar_template sidebar_template_cover_letter ${
                      chosenCategory === choose_template.name
                        ? 'template_selected'
                        : null
                    }`}
                  >
                    <div className='templateHeading'>
                      {choose_template.heading}
                    </div>
                    <img src={choose_template.img} alt={choose_template.alt} />
                  </div>
                ))}
            </div>
          </div>
          <h6 style={{ marginTop: '3rem', color: '#ed9131' }}>
            *The categorisations are merely advisory, you can select any of the
            16 cover letter templates, then, amend it to fit your purpose or
            application.
          </h6>
        </div>
        {/* <CoverLetterDocument mainPanelBgColor={mainPanelBgColor} sidePanelTextColor={sidePanelTextColor} sidePanelBgColor={sidePanelBgColor} pageUpdatableData={pageUpdatableData} pageLayout={pageLayout} lineHeight={lineHeight} docummentMargin={docummentMargin} docummentDateFormat={docummentDateFormat} documentHeadingTextStyle={documentHeadingTextStyle} documentBodyTextStyle={documentBodyTextStyle} documentBodyTextSize={documentBodyTextSize} /> */}
