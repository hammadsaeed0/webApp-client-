...
export default function ProfileLinkedInHeadline({ userLoggedIn, userData }) {
  ...
  const [pageData, setPageData] = useState(
    getPageData?.type === 'linkedin_headline' && getPageData
  );
          ...
          >
            <div>
              ...
              <p style={{ marginBottom: '1rem' }}>
                Are you sure you want to delete the Headline {resume_name} ?
              </p>
      ...
      <div className='profile_main'>
        ...
        <div className='profile_hero_resume'>
          <div className='profile_header'>
            ...
            <Link to={'/linkedIn_headline'} className='go_to_builder'>
              <img
          ...
          {!linkedinHeadlines ? (
                      ...
                      />
                        ...
                        <td>
                          <svg
                            onClick={() =>
                              history.push(
                                `/linkedIn_headline/edit/${pageData.id}`
                              )
                            }
                            viewBox='0 0 24 24'
                            fill='#fff'
                          ...
                          <a
                            href={`/linkedIn_headline_view/edit/${pageData.id}`}
                            target='_blank'
                            rel='noreferrer'
                          >
                            <svg
                              // onClick={() => history.push(`/linkedIn_headline_view/edit/${pageData.id}`) }
                              x='0px'
                              y='0px'
                              viewBox='0 0 490 490'
                            >
            ...
            >
              ...
              <img
                style={{ maxWidth: '150%' }}
                src='/assets/images/no_linkedin_headline.png'
                alt='create new linkedin resume'
              />
              {/* No Linkedin Headlines Yet? <br /> Create New Linkedin Headline */}
            </div>
          )}
        </div>
      </div>
