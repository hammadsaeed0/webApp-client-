...
const Template3 = ({
  ...
  // const [dataUpdatableRight, setDataUpdatableRight] = useState(dataRightSection)
  // const [dataUpdatableLeft, setDataUpdatableLeft] = useState(dataLeftSection)
              ...
              <div className='skillsModal'>
                {data.map((skill) => (
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{ width: '75%' }}>
                      <BuilderEditor readOnly={readOnly} content={skill.name} />
                    </div>
                    <div
                      style={{ cursor: 'pointer' }}
        ...
        <>
          {
            <div key={data.key} ref={data.ref} className={data.class}>
              ...
              <div className='section'>
                {data.heading === 'none' ? null : data.header ? (
                  <div
                    ...
                    className={`section_heading template_3_header  
                        ${headingTextStyleConditions}
                  ...
                  >
                    {/* {index} */}
                    {/* <BuilderEditor readOnly={readOnly} key={index+1} content={data.heading} /> */}
                    ...
                    <div>
                      ...
                      >
                        ...
                        <BuilderEditor
                          readOnly={readOnly}
                          key={index + 1}
                          content={data.heading[0].name}
                          setEditorData={data.heading[0].setName}
                        />
                      </div>
                      <BuilderEditor
                        readOnly={readOnly}
                        key={index + 1}
                        content={data.heading[0].position}
                        setEditorData={data.heading[0].setPosition}
                      />
                    </div>
                      ...
                      <div style={{ width: '40%' }}>
                        ...
                        >
                          {data.name && (
                            <svg
                              ...
                              onClick={() =>
                                proTips_Modal(
                                  data.name &&
                                    BuilderProtip(data.name[0]).BuilderProtip
                                      .heading,
                                  data.name &&
                                    BuilderProtip(data.name[0]).BuilderProtip
                                      .body
                          ...
                          <BuilderEditor
                            readOnly={readOnly}
                            key={index + 1}
                            content={data.heading[0]}
                            setEditorData={data.setHeading[0]}
                          />
                        </div>
                      </div>
                      <div style={{ width: '25%' }}>
                        ...
                        >
                          {data.name && (
                            <svg
                              ...
                              onClick={() =>
                                proTips_Modal(
                                  data.name &&
                                    BuilderProtip(data.name[1]).BuilderProtip
                                      .heading,
                                  data.name &&
                                    BuilderProtip(data.name[1]).BuilderProtip
                                      .body
                          ...
                          <BuilderEditor
                            readOnly={readOnly}
                            key={index + 1}
                            content={data.heading[1]}
                            setEditorData={data.setHeading[1]}
                          />
                        </div>
                      </div>
                      <div style={{ width: '25%' }}>
                        ...
                        >
                          {data.name && (
                            <svg
                              ...
                              onClick={() =>
                                proTips_Modal(
                                  data.name &&
                                    BuilderProtip(data.name[2]).BuilderProtip
                                      .heading,
                                  data.name &&
                                    BuilderProtip(data.name[2]).BuilderProtip
                                      .body
                          ...
                          <BuilderEditor
                            ...
                            setEditorData={data.setHeading[2]}
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div
                  ...
                  className='Template_3_divider_main'
                ></div>

                {data.description ===
                'none' ? null : data.header ? null : data.footer ? (
                  ...
                  >
                    <div
                      ...
                      className='template_3_subsection_footer'
                    >
                      <div className='section' style={{ width: '40%' }}>
                        {data.description[0].map((descp, index) => (
                          <div
                            key={descp.key}
                            className='template_1_subSection sectionWithoutPadding'
                          >
                            ...
                            <div
                              key={index + 1}
                              className={`template_3_description description
                                                    ${bodyTextStyleConditions}
                            ...
                            >
                              ...
                              <div
                                style={{ width: '20%' }}
                                onClick={() =>
                                  changeExperticeModal(data.description[0])
                                }
                              >
                                ...
                                <div
                                  ...
                                  className='progressBarContainer_template_3'
                                >
                                  {/* {descp.expertice} */}
                                  <div
                                    style={{
                      ...
                      <div className='section' style={{ width: '25%' }}>
                        <BuilderEditor
                          readOnly={readOnly}
                          content={data.description[1]}
                          setEditorData={data.setDescription[1]}
                        />
                      </div>
                      <div className='section' style={{ width: '25%' }}>
                        <BuilderEditor
                          readOnly={readOnly}
                          content={data.description[2]}
                          setEditorData={data.setDescription[2]}
                        />
                      </div>
                    </div>
                  </div>
                ...
                data.subSection === 'education' ? (
                  data.description.map((descp, index) => (
                    ...
                    >
                      ...
                      <div
                        key={index + 1}
                        className={`template_3_description_with_subsection description
                                    ${bodyTextStyleConditions}
                        ...
                        style={{ color: sidePanelTextColor }}
                      >
                        <div className='template_3_subsection_header'>
                          <BuilderEditor
                            readOnly={readOnly}
                          ...
                          <BuilderEditor
                            ...
                            setEditorData={data.setTenure}
                          />
                        </div>
                        <div className='template_3_subsection_main'>
                          <BuilderEditor
                            readOnly={readOnly}
                      ...
                      >
                        <div className='template_3_subsection_header'>
                          ...
                          <BuilderEditor
                            ...
                            setEditorData={data.setPosition}
                          />
                        </div>
                        <div className='template_3_subsection_main'>
                          <div style={{ width: '70%' }}>
                    ...
                    {data.description.map((descp, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {/* <div style={{cursor: 'pointer'}} className='progressBarContainer'> */}
                            {/* {descp.expertice} */}
                            <div
                              style={{ width: descp.expertice + '%' }}
                              className='progressBarCompleted'
                            >
                              {' '}
                            </div>
        ...
        <>
          <div key={descp.key} className='block' ref={descp.ref}>
            ...
            <div className='sidebar_section '>
              ...
              <div
                className={index === 0 ? '' : 'Template_2_divider_sidebar'}
              ></div>
              <div
                key={index + 1}
                style={{ color: sidePanelTextColor }}
