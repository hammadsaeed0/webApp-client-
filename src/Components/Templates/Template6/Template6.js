...
const Template6 = ({
  ...
  // // console.log(page)
  // // console.log("From Template 6" ,  dataUpdatableLeft[1])
  // // console.log("From Template 6" , dataUpdatableRight)
        ...
        <>
          {
            <div
              ...
              style={{ display: index === 0 || index === 1 ? 'nome' : null }}
            >
              ...
              <div className='section'>
                {data.heading === 'none' ? null : data.header ? null : (
                  <div
                ...
                {data.description ===
                'none' ? null : data.header ? null : data.type ===
                  'education' ? (
                  <div
                    style={{
                      display: 'flex',
                        ...
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex = data.honor.findIndex(
                                  (e) => e.key === descp.key
                                );
                                delete_subsection_Modal(
                                  data.honor,
                            ...
                            <span
                              ...
                              onClick={(e) => {
                                ...
                                const arr = array_copy(data.honor, findIndex);
                                // array_copy(data.honor, findIndex);
                                setDataUpdatableRight(arr);
                                setFilteredArray(arr);
                                dataOnRight();
                                setTemp(index + 1);
  ...
  // // console.log(dataUpdatableLeft.filter(e => page === 1 ? e.firstPage === true : null).map((descp, index) => descp.description.map((data, index) => data)))
  ...
  // // console.log(dataUpdatableRight[3].description.map((descp, index) => (descp.name)))
        ...
        >
          ...
          >
            ...
            <div style={{ color: mainPanelBgColor, marginBottom: '-10px' }}>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].heading[0].phone}
                setEditorData={dataUpdatableLeft[0].heading[0].setPhone}
              />
            </div>
            <div>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].description[0].phoneDescp}
                setEditorData={
                  dataUpdatableLeft[0].description[0].setPhoneDescp
                }
              />
            </div>
            <div style={{ color: mainPanelBgColor, marginBottom: '-10px' }}>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].heading[1].email}
                setEditorData={dataUpdatableLeft[0].heading[1].setEmail}
              />
            </div>
            <div>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].description[1].emailDescp}
                setEditorData={
                  dataUpdatableLeft[0].description[1].setEmailDescp
                }
              />
            </div>
            <div style={{ color: mainPanelBgColor, marginBottom: '-10px' }}>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].heading[2].address}
                setEditorData={dataUpdatableLeft[0].heading[2].setAddress}
              />
            </div>
            <div>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableLeft[0].description[2].addressDescp}
                setEditorData={
                  dataUpdatableLeft[0].description[2].setAddressDescp
                }
              />
            </div>
          </div>
          <div
            ...
            className={` Template_6_sidebarHero ${
              docummentMargin === 'Compact'
                ? 'sidebar_compact'
                : docummentMargin === 'Narrow'
                ? 'sidebar_narrow'
            ...
            <div className='section'>
              ...
              >
                ...
                >
                  {dataUpdatableRight[1].name && (
                    <svg
                      ...
                      onClick={() =>
                        proTips_Modal(
                          dataUpdatableRight[1].name &&
                            BuilderProtip(dataUpdatableRight[1].name)
                              .BuilderProtip.heading,
                          dataUpdatableRight[1].name &&
                            BuilderProtip(dataUpdatableRight[1].name)
                              .BuilderProtip.body
                  ...
                  <BuilderEditor
                    readOnly={readOnly}
                    key={dataUpdatableRight[1].key}
                    content={dataUpdatableRight[1].heading}
                    setEditorData={dataUpdatableRight[1].setHeading}
                  />
                </div>
              </div>
              ...
              >
                <BuilderEditor
                  readOnly={readOnly}
                  content={dataUpdatableRight[1].description[0].description}
                  setEditorData={
                    dataUpdatableRight[1].description[0].setDescription
                  }
                />
              </div>
              ...
              >
                {dataUpdatableRight[1].languageSkill.map((data, index) => (
                  <div
                    key={index + 1}
                    className={`template_4_description 
                                        ${bodyTextStyleConditions}
                    ...
                    <div
                      ...
                      onClick={() => {
                        changeExperticeModal(
                          dataUpdatableRight[1].languageSkill
                        );
                        dataOnRight();
                        setTemp(16);
                      }}
