                  ...
                  >
                    {data.description.map((descp, index) => (
                      ...
                      >
                        ...
                        >
                          <div className='template_10_language_wrapper'>
                            <div className='template_10_language_circle'>
                              <div
                                onClick={() => {
                              ...
                              >
                                <CircularProgressbar
                                  value={descp.expertice}
                                  strokeWidth='5'
                                  text={`${descp.expertice}%`}
                                  styles={buildStyles({
                                    // Text size
                                    textSize: '20px',
          ...
          <div key={descp.key} className='block' ref={descp.ref}>
            ...
            <div className='sidebar_section '>
              ...
              {descp.header ? null : descp.subHeader ===
                ...
                'none' ? null : descp.type === 'education' ? (
                <div>
