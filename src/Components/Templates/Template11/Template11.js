              ...
              <div className='section'>
                {data.header ? null : data.heading === 'none' ? null : (
                  ...
                  >
                    ...
                    >
                      <div
                        style={{ width: '15%', border: '1px solid #CFC8C3' }}
                      ></div>
        ...
        <>
          <div key={descp.key} className='block' ref={descp.ref}>
            ...
            <div className='sidebar_section '>
              ...
              {descp.header ? null : descp.subHeader ===
                'none' ? null : descp.description ===
                'none' ? null : descp.type === 'language' ? (
                <div>
                        ...
                        <div style={{ marginLeft: '3px' }}>
                          <div className='template_5_software_level'>
                            ...
                            <div
                              style={{
                                backgroundColor:
                                  data.expertice >= 20 ? '#3B3334' : '#CFC8C3',
                              }}
                              onClick={(e) => {
                            ...
                            <div
                              style={{
                                backgroundColor:
                                  data.expertice >= 40 ? '#3B3334' : '#CFC8C3',
                              }}
                              onClick={(e) => {
                            ...
                            <div
                              style={{
                                backgroundColor:
                                  data.expertice >= 60 ? '#3B3334' : '#CFC8C3',
                              }}
                              onClick={(e) => {
                            ...
                            <div
                              style={{
                                backgroundColor:
                                  data.expertice >= 80 ? '#3B3334' : '#CFC8C3',
                              }}
                              onClick={(e) => {
                            ...
                            <div
                              style={{
                                backgroundColor:
                                  data.expertice >= 100 ? '#3B3334' : '#CFC8C3',
                              }}
                              onClick={(e) => {
        ...
        >
          ...
          <div
            style={{
              ...
              borderRight: '1px solid #CFC8C3',
            }}
          ></div>
          <div
            style={{ width: '85%', paddingTop: '3rem' }}
            className={` ${
          ...
          >
            <div style={{ display: page === 1 ? null : 'none' }}>
              <div style={{ padding: '0' }} className='section'>
                <div>
                  <div
                    style={{
                      display: 'flex',
                ...
                >
                  <div
                    style={{ border: '1px solid #CFC8C3', width: '20%' }}
                  ></div>
                  <div>
                    <BuilderEditor
                      readOnly={readOnly}
                ...
                <div>
                  <BuilderEditor
                    readOnly={readOnly}
                    content={dataUpdatableRight[0].detail}
                    setEditorData={dataUpdatableRight[0].setDetail}
                  />
                </div>
                <div
                  style={{
