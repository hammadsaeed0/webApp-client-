...
const Template30 = ({
  ...
  return (
    <div className='template_4_page'>
                ...
                proTips_Modal(
                  dataUpdatableRight[0].name &&
                    BuilderProtip(dataUpdatableRight[0].name).BuilderProtip
                      .heading,
                  dataUpdatableRight[0].name &&
                    BuilderProtip(dataUpdatableRight[0].name).BuilderProtip.body
                )
              }
            >
              <g>
      ...
      <div style={{}} className='template_4_hero_section'>
        <div
          style={{
            width: '35%',
            ...
            color: '#fff',
            paddingBottom: '2rem',
            marginBottom: page === 1 ? '19rem' : '4rem',
            marginTop: page === 1 ? null : '2rem',
          }}
        ...
        <div
          style={{ width: '65%', background: mainPanelBgColor }}
