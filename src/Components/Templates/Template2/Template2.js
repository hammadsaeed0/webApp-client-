...
import { main_header } from './Template2Data';
...
const Template2 = ({
        ...
        <>
          {
            <div key={data.key} ref={data.ref} className={data.class}>
              ...
              <div className='section'>
                ...
                <div className='Template_2_divider_main'></div>
                  ...
                  data.description.map((descp, index) => (
                    <div className='template_1_subSection section'>
                      ...
                      <div
                        ...
                        style={{ color: sidePanelTextColor }}
                      >
                        <div className='template_2_subsection_sidebar'>
                          <BuilderEditor
                            readOnly={readOnly}
                        ...
                        <div className='Template_2_subsection_divider'>
                          <div className='Template_2_subsection_startMark'></div>
                          <div className='Template_2_subsection_line'></div>
                        </div>
                ...
                data.type === 'skills' ? (
                  // <div onClick={() => changeExperticeModal(data.description)}>
                  <div>
                    {data.description.map((descp, index) => (
                      <div className='template_1_subSection section'>
                        <div className='subsectionCopyDelIconWrapper'>
  ...
  return (
    <div style={{ padding: '2rem 0' }} className='blankTemplate_page'>
      <div
        style={{ background: sidePanelBgColor }}
        className={`Template_2_sidebar ${
