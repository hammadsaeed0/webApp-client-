...
const Template19 = ({
  ...
  return (
    <div style={{ padding: '3rem 2rem 1rem' }} className='template_4_page'>
      <div
      ...
      >
        ...
        <div className='section' style={{ marginBottom: '1rem' }}>
          <div>
            ...
            >
              {dataUpdatableRight[0].professional_protip && (
                <svg
                  className='builder_protip'
                  style={{ display: showProtip ? '' : 'none' }}
                  viewBox='0 0 24 24'
                  ...
                  onClick={() =>
                    proTips_Modal(
                      dataUpdatableRight[0].professional_protip &&
                        BuilderProtip(dataUpdatableRight[0].professional_protip)
              ...
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableRight[0].personalinfo}
                setEditorData={dataUpdatableRight[0].setPersonalinfo}
              />
            </div>
          </div>
          <div>
        ...
        <div
          className='section template_15_subHeader'
          style={{
        ...
        >
          {dataUpdatableRight[0].contact.map((contact, index) => (
            <div
              key={index}
              style={{
                display: 'flex',
