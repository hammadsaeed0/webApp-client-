...
const Template15 = ({
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            <BuilderEditor
                              readOnly={readOnly}
                              content={descp.address}
                              setEditorData={descp.setAddress}
                            />
                          </div>
                        </div>
                        <div>
  ...
  return (
    <div style={{ padding: '0 3rem' }} className='template_4_page'>
      <div
        style={{
        ...
        <div style={{ color: sidePanelBgColor }}>
          ...
          >
            ...
            <BuilderEditor
              ...
              setEditorData={dataUpdatableLeft[0].setsetHeading}
            />
          </div>
        </div>
        <BuilderEditor
          ...
          setEditorData={dataUpdatableLeft[0].setsetPosition}
        />

        <div
          style={{ display: page === 1 ? 'null' : 'none', padding: '0' }}
