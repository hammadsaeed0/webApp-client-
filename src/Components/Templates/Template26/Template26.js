...
const Template26 = ({
  ...
  return (
    <div style={{ position: 'relative' }} className='template_4_page'>
      <div
        style={{ display: page === 1 ? 'block' : 'none', padding: '0 1.5rem' }}
        className='section'
      >
        <div
          className='section'
        ...
        >
          ...
          >
            <BuilderEditor
              readOnly={readOnly}
              content={dataUpdatableRight[0].bottomName}
              setEditorData={dataUpdatableRight[0].setBottomName}
            />
          </div>
        </div>
      </div>
