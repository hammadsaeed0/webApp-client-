...
export default function COVERLETTER34DATA() {
  ...
  const [position, setPosition] = useState({
    blocks: [
      {
        key: '637gr',
        text: 'Arnold Road, Guildford AN1 1CV | 01632 960 314 \njerrydavid@example.com',
        type: 'unstyled',
        depth: 0,
        inlineStyleRanges: [
          {
