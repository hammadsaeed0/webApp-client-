...
export default function CoverLetter7({ showProtip, readOnly, chosenCategory, sidePanelTextColor, sidePanelBgColor, mainPanelBgColor, page, rightMainRef, setDataUpdatableLeft, dataUpdatableLeft, dataUpdatableRight, setDataUpdatableRight, docummentMargin, documentHeadingTextStyle, documentBodyTextStyle, documentBodyTextSize, headingTextStyleConditions, bodyTextStyleConditions, headingTextSizeConditions, bodyTextSizeConditions, }) {
  ...
  return (
    <div style={{ minHeight: '29.7cm' }} className='blankTemplate_page'>
      <div
        style={{
          width: '100%',
      ...
      >
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '20%', padding: '0' }} className="Template_5_header"> 
          <div style={{display: page === 1 ? 'flex' : 'none', width: '30%', height: '100%', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', backgroundColor: sidePanelBgColor, paddingRight: '1rem' }} 
              className={`${docummentMargin === 'Compact' ? 'sidebar_compact' : docummentMargin === 'Narrow' ? 'sidebar_narrow' :  docummentMargin === 'Normal' ? 'sidebar_normal':  docummentMargin === 'Wide' ? 'sidebar_wide' :   docummentMargin === 'Broad' ? 'sidebar_broad' : null}`}
          >
              {/* {dataUpdatableLeft[0].heading[0].phone} */}
              <div style={{color: mainPanelBgColor, marginBottom: '-10px'}}>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].heading[0].phone} setEditorData={dataUpdatableLeft[0].heading[0].setPhone} />
              </div>
              <div>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].description[0].phoneDescp} setEditorData={dataUpdatableLeft[0].description[0].setPhoneDescp} />
              </div>
              <div style={{color: mainPanelBgColor, marginBottom: '-10px'}}>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].heading[1].email} setEditorData={dataUpdatableLeft[0].heading[1].setEmail} />
              </div>
              <div>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].description[1].emailDescp} setEditorData={dataUpdatableLeft[0].description[1].setEmailDescp} />
              </div>
              <div style={{color: mainPanelBgColor, marginBottom: '-10px'}}>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].heading[2].address} setEditorData={dataUpdatableLeft[0].heading[2].setAddress} />
              </div>
              <div>
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].description[2].addressDescp} setEditorData={dataUpdatableLeft[0].description[2].setAddressDescp} />
              </div>
          </div>

          <div style={{ display: page === 1 ? null : 'none', width: '70%', height: '100%', background: mainPanelBgColor, display: 'flex', justifyContent: 'center', alignItems: 'start', flexDirection: 'column', }}
          className={` ${docummentMargin === 'Compact' ? 'compact' : docummentMargin === 'Narrow' ? 'narrow' :  docummentMargin === 'Normal' ? 'normal':  docummentMargin === 'Wide' ? 'wide' :   docummentMargin === 'Broad' ? 'broad' : null}`}>
              {/* {dataUpdatableRight[0]} */}
              <div className='section' style={{ marginTop: '1rem',  display: 'flex',
              ...
              />
                  ...
                  <BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[1].heading} setEditorData={dataUpdatableLeft[1].setHeading} />
              </div>
              <div className='section' style={{ display: 'flex', justifyContent: 'start', alignItems: 'center', gap: '1rem', width: '100%' }} >
                  <div><BuilderEditor readOnly={readOnly} style={{ width: 'auto' }} content={dataUpdatableLeft[1].position} setEditorData={dataUpdatableLeft[1].setPosition} /></div>
                  <div style={{ width: '60%', border: '1px solid #342C2D' }}></div>
              </div>
          </div>
        </div>
