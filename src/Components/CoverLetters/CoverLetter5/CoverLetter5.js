  ...
  return (
    <div className='blankTemplate_page'>
      <div
        ...
        style={{ width: '0%', padding: '0mm', margin: '0rem' }}
      >
        <div
          style={{
      ...
      >
        <div style={{  }}>
          <div style={{ display: page === 1 ? null : 'none' , background: sidePanelBgColor, padding: '2rem 3rem' }} className='template_4_header'>
              <div style={{ marginBottom: '1rem', width: '100%' }}> <span>
              ...
              />
            </span><BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].heading} setEditorData={dataUpdatableLeft[0].setHeading} /></div>
              <div style={{ }}><BuilderEditor readOnly={readOnly} content={dataUpdatableLeft[0].description} setEditorData={dataUpdatableLeft[0].setDescription} /></div>
          </div>
          <div style={{ display: page === 1 ? null : 'none'  , borderBottom: `2px solid ${sidePanelTextColor}`}} className='template_4_subHeader'>
              {dataUpdatableLeft[1].heading.map((subHeaderSection, index) => (
                  ...
                  {/*  */}
                      <BuilderEditor readOnly={readOnly} content={subHeaderSection.data} setEditorData={subHeaderSection.setData} />
                  </div>
              ))}
          </div>
        </div>
