...
export default function CoverLetter12({
  showProtip,
  readOnly,
  chosenCategory,
  sidePanelTextColor,
  ...
  return (
    <div className='template_4_page'>
      <div style={{ minHeight: '29.7cm' }} className='template_4_hero_section'>
        <div
          style={{
            display: 'flex',
            justifyContent: 'start',
        ...
        >
          ...
          ></div>
          <div
            style={{ width: '85%', paddingTop: '0rem' }}
            className={` ${
          ...
          >
            ...
            >
              <div
                style={{ padding: '0', paddingTop: '3rem', width: '100%' }}
                className='section'
              >
                <div style={{ width: '100%' }}>
                  <span>
            ...
            <div ref={rightMainRef} className={`blankTemplate_profile  `}>
              <div className='blankTemplate_header section '>
                ...
                {dataUpdatableRight[0].description.LETTER_HEADING.blocks
                  .length > 0 && (
                  <div>
                    <span>
                      <CoverLetterProtip
                ...
                {dataUpdatableRight[0].description.REQUEST.blocks.length >
                  0 && (
                  <div>
                    <span>
                      <CoverLetterProtip
                    ...
                    <BuilderEditor
                      ...
                      setEditorData={
                        dataUpdatableRight[0].description.setREQUEST
                      }
                    />
                  </div>
                )}
