...
export default function CoverLetter28({
  showProtip,
  readOnly,
  chosenCategory,
  sidePanelTextColor,
        ...
        <>
          ...
          >
            ...
            <div className='sidebar_section '>
              ...
              {/* <div style={{ width: '100%', borderColor: '#333333' }} className={'Template_4_divider_sidebar'} ></div> */}
          ...
          >
            <div style={{ width: '100%' }}>
              ...
              <BuilderEditor
                ...
                setEditorData={
                  dataUpdatableLeft[0].description[0].setDescription
                }
              />
            </div>
          </div>
