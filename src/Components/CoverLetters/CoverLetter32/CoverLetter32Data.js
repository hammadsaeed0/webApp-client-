...
export default function COVERLETTER32DATA() {
  const [name, setName] = useState({
    blocks: [
      {
        key: '637gr',
        text: 'JIMINEY CRICKET',
        type: 'unstyled',
        depth: 0,
        inlineStyleRanges: [
          {
  ...
  const [position, setPosition] = useState({
    blocks: [
      {
        key: '637gr',
        text: 'Lagos, Nigeria (Willing to Relocate) \n+234-910-9006-7347 \nLinkedInProfile * jimineycricket@gmail.com',
        type: 'unstyled',
        depth: 0,
        inlineStyleRanges: [
          {
