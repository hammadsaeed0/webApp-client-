        ...
        <>
          {
            ...
            >
              ...
              <div className='section'>
                        ...
                        >
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={data.variable.exp_challenge}
                                setEditorData={data.variable.setExp_challenge}
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={descp.exp_challenge_descp}
                                setEditorData={descp.setExp_challenge_descp}
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={data.variable.exp_action}
                                setEditorData={data.variable.setExp_action}
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={descp.exp_action_descp}
                                setEditorData={descp.setExp_action_descp}
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={data.variable.exp_results}
                                setEditorData={data.variable.setExp_results}
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={descp.exp_results_descp}
                                setEditorData={descp.setExp_results_descp}
                              />
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.leadership_graph[0].chartValue_2}
                              setEditorData={
                                data.leadership_graph[0].setChartValue_2
                              }
                            />
                          </div>
                          <div
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.leadership_graph[0].chartValue_3}
                              setEditorData={
                                data.leadership_graph[0].setChartValue_3
                              }
                            />
                          </div>
                          <div
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.leadership_graph[0].chartValue_4}
                              setEditorData={
                                data.leadership_graph[0].setChartValue_4
                              }
                            />
                          </div>
                        </div>
                        ...
                        >
                          <BuilderEditor
                            readOnly={readOnly}
                            content={data.leadership_graph[0].chartValue_descp}
                            setEditorData={
                              data.leadership_graph[0].setChartValue_descp
                            }
                          />
                        </div>
                      </div>
                          ...
                          <div
                            ...
                            style={{
                              ...
                              background: descp.background
                                ...
                                : null,
                              border: descp.border
                                ? `1px solid ${sidePanelBgColor}`
                                : null,
                              padding: descp.background
                                ? '0.2rem 2rem 0.2rem 0.5rem'
                                : '0.1rem 0.5rem',
                            }}
                          >
                            <div
                ...
                ) : data.type === 'main' || data.type === 'main_descp' ? (
                  <div>
                    {data.description.map((descp, index) => (
                      <div
                        key={descp.key}
...
export default ExecutiveTemplate8;
