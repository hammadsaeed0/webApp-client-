                    ...
                    >
                      <div>
                        ...
                        >
                          ...
                          >
                            {data.leadership_graph[0].proTip_name && (
                              <svg
                                className='builder_protip'
                                style={{
                            ...
                            <BuilderEditor
                              readOnly={readOnly}
                              content={
                                data.leadership_graph[0].chartValue_descp
                              }
                              setEditorData={
...
export default ExecutiveTemplate7;
