...
const ExecutiveTemplate6 = ({
                ...
                {data.header ? null : data.heading === 'none' ? null : (
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          background: data.no_heading_background
                            ? null
                            : sidePanelBgColor,
                        }}
                      >
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.growth_graph[0].chartValue_1}
                              setEditorData={
                                data.growth_graph[0].setChartValue_1
                              }
                            />
                          </div>
                          <div
                          ...
                          >
                            ...
                            <div style={{ padding: '0 5px', width: '70px' }}>
                              <div
                                style={{
                                  background: '#fca01f',
                                  padding: '3px',
                              ...
                              >
                                <BuilderEditor
                                  readOnly={readOnly}
                                  content={data.growth_graph[0].chartValue_2}
                                  setEditorData={
                                    data.growth_graph[0].setChartValue_2
                                  }
                                />
                              </div>
                              <div
                              ...
                              >
                                <BuilderEditor
                                  readOnly={readOnly}
                                  content={data.growth_graph[0].chartValue_3}
                                  setEditorData={
                                    data.growth_graph[0].setChartValue_3
                                  }
                                />
                              </div>
                              <div
                              ...
                              >
                                <BuilderEditor
                                  readOnly={readOnly}
                                  content={data.growth_graph[0].chartValue_4}
                                  setEditorData={
                                    data.growth_graph[0].setChartValue_4
                                  }
                                />
                              </div>
                            </div>
                        ...
                        >
                          <BuilderEditor
                            readOnly={readOnly}
                            content={data.growth_graph[0].chartValue_descp}
                            setEditorData={
                              data.growth_graph[0].setChartValue_descp
                            }
                          />
                        </div>
                      </div>
  ...
  return (
    <div style={{ padding: '0' }} className='template_4_page'>
      <div
        style={{
...
export default ExecutiveTemplate6;
