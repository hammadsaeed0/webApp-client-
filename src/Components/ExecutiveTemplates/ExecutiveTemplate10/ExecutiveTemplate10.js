...
const ExecutiveTemplate10 = ({
        ...
        <>
          {
            <div
              style={{
                display: page === 1 && index === 0 ? 'none' : null,
              }}
              key={data.key}
              ref={data.ref}
            ...
            >
              ...
              <div className='section'>
                  ...
                  >
                    <div
                      style={{
                        ...
                        justifyContent:
                          data.type === 'main' ? 'center' : 'start',
                        width: data.type === 'main' ? '100%' : 'auto',
                        alignItems: data.type === 'main' ? 'center' : 'start',
                        color: sidePanelBgColor,
                      }}
                    >
                      <div
                        style={{
                          width: data.type === 'main' ? '100%' : 'auto',
                          border: `2px solid ${sidePanelBgColor}`,
                        }}
                      >
                        <div
                          style={{
                      ...
                      >
                        {data.type === 'main'
                          ? data.subHeading.map((subHeading) => (
                              <div
                                key={subHeading.key}
                                style={{
                                ...
                                >
                                  <span
                                    ...
                                    onClick={(e) => {
                                      // dataOnRight();
                                      const findIndex =
                                        data.subHeading.findIndex(
                                          (e) => e.key === subHeading.key
                                        );
                                ...
                                >
                                  ...
                                  >
                                    <BuilderEditor
                                      ...
                                      setEditorData={subHeading.setDescription}
                                    />
                                  </div>
                                </div>
                              </div>
                ...
                {data.header ? null : data.description ===
                  ...
                  data.description.map((descp, index) => (
                    ...
                    >
                      ...
                      <div
                        key={index + 1}
                        className={`template_5_description_with_subsection ${bodyTextStyleConditions} ${bodyTextSizeConditions} `}
                      ...
                      >
                        <div
                          ...
                          className='template_5_subsection_sidebar'
                        >
                          <div>
                            <BuilderEditor
                              readOnly={readOnly}
                              content={descp.exp_heading}
                              setEditorData={descp.setExp_heading}
                            />
                          </div>
                          <div>
                            <BuilderEditor
                              readOnly={readOnly}
                              content={descp.exp_tenure}
                              setEditorData={descp.setExp_tenure}
                            />
                          </div>
                        </div>
                        <div
                        ...
                        >
                          <div>
                            <BuilderEditor
                              readOnly={readOnly}
                              content={descp.exp_subHeading}
                              setEditorData={descp.setExp_subHeading}
                            />
                          </div>
                          <div
                            style={{
                          ...
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={descp.exp_subHeadings.subHeading_1}
                                setEditorData={
                                  descp.exp_subHeadings.setSubHeading_1
                                }
                              />
                            </div>
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={descp.exp_subHeadings.subHeading_2}
                                setEditorData={
                                  descp.exp_subHeadings.setSubHeading_2
                                }
                              />
                            </div>
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
                                content={descp.exp_subHeadings.subHeading_3}
                                setEditorData={
                                  descp.exp_subHeadings.setSubHeading_3
                                }
                              />
                            </div>
                          </div>
                        ...
                        >
                          <BuilderEditor
                            readOnly={readOnly}
                            content={descp.exp_descp}
                            setEditorData={descp.setExp_descp}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.chart[0].description}
                              setEditorData={data.chart[0].setDescription}
                            />
                          </div>
                          <div
                            style={{
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.chart[1].description}
                              setEditorData={data.chart[1].setDescription}
                            />
                          </div>
                          <div
                            style={{
                          ...
                          >
                            <BuilderEditor
                              readOnly={readOnly}
                              content={data.chart[2].description}
                              setEditorData={data.chart[2].setDescription}
                            />
                          </div>
                        </div>
                      </div>
                ...
                ) : data.type === 'main' || data.type === 'interests' ? (
                  <div>
                    {data.description.map((descp, index) => (
                      <div
                        key={descp.key}
                        style={{
                          background: data.background ? mainPanelBgColor : '',
                        }}
                        className='template_1_subSection section'
                      >
                        <div
                  ...
                  >
                    <div style={{ width: '25%' }}>
                      ...
                      >
                        <div
                          key={index + 1}
                          className={`template_2_description_with_subsection section ${bodyTextStyleConditions} ${bodyTextSizeConditions} `}
                          style={{
                            color: '#fff',
                            display: 'flex',
                            justifyContent: 'center',
                        ...
                        >
                          <BuilderEditor
                            readOnly={readOnly}
                            content={data.growthCircle}
                            setEditorData={data.setGrowthCircle}
                          />
                        </div>
                      </div>
                      {/* ))} */}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div
                            style={{ width: '100%' }}
                            className='template_5_subsection_main'
                          >
                            <div>
                              <BuilderEditor
                                readOnly={readOnly}
  ...
  return (
    <div style={{ padding: '0 1.5rem' }} className='template_4_page'>
      <div
        style={
          {
...
export default ExecutiveTemplate10;
