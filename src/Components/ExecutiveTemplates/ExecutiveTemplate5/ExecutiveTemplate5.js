        ...
        <>
          {
            ...
            >
              ...
              <div style={{ marginBottom: '0.5rem' }} className='section'>
                ...
                {data.header ? null : data.description ===
                  ...
                  >
                    <div style={{ width: '75%', background: mainPanelBgColor }}>
                        ...
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex = data.description_2.findIndex(
                                  (e) => e.key === descp.key
                                );
                                delete_subsection_Modal(
                                  data.description_2,
                  ...
                  <div style={{}}>
                        ...
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex = data.actions.findIndex(
                                  (e) => e.key === descp.key
                                );
                                delete_subsection_Modal(
                                  data.actions,
                            ...
                            <span
                              ...
                              onClick={(e) => {
                                ...
                                const arr = array_copy(data.actions, findIndex);
                                // array_copy(data.description, findIndex);
                                setDataUpdatableRight(arr);
                                setFilteredArray(arr);
                                dataOnRight();
                    ...
                    <div
                      style={{ borderBottom: `1px solid ${sidePanelBgColor}` }}
                    >
                      {data.main_description.map((descp, index) => (
                        <div
                          key={descp.key}
                          className='template_1_subSection section'
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex =
                                  data.main_description.findIndex(
                                    (e) => e.key === descp.key
                                  );
                                delete_subsection_Modal(
...
export default ExecutiveTemplate5;
