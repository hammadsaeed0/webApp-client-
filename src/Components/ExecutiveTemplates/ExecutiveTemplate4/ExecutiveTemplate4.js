              ...
              <div className='section'>
                {data.header ? null : data.heading === 'none' ? null : (
                  <div
                    ...
                    rows='1'
                    placeholder='Enter'
                    style={{ background: sidePanelBgColor, color: '#fff' }}
                      ...
                      >
                        <div>
                          <BuilderEditor
                            readOnly={readOnly}
                            key={index + 1}
                            content={data.recognitions}
                            setEditorData={data.setRecognitions}
                          />
                        </div>
                      </div>

                      {/* Description */}
                      {data.recognitions_descp.map((descp, index) => (
                        <div
                          key={descp.key}
                          className='template_1_subSection section'
                        >
                          <div className='subsectionCopyDelIconWrapper'>
                            <span
                              ...
                              onClick={(e) => {
                                // dataOnRight();
                                const findIndex =
                                  data.recognitions_descp.findIndex(
                                    (e) => e.key === descp.key
                                  );
                                delete_subsection_Modal(
                                  data.recognitions_descp,
                                  findIndex,
                                  'right'
                                );
                                dataOnRight();
                  ...
                  <div>
                    ...
                    >
                      <div>
                        <BuilderEditor
                          readOnly={readOnly}
                          content={data.main_description}
                          setEditorData={data.setMain_description}
                        />
                      </div>
                    </div>
                    <div
                ...
                ) : data.type === 'section_only' ? (
                  <div
                    style={{
                      borderTop: `1px solid ${sidePanelBgColor}`,
        ...
        >
          <div>
            ...
            <div>
              <BuilderEditor
                readOnly={readOnly}
                content={dataUpdatableRight[0].headLine}
                setEditorData={dataUpdatableRight[0].setHeadLine}
              />
            </div>
          </div>
          <div
          ...
          >
            <BuilderEditor
              readOnly={readOnly}
              content={dataUpdatableRight[0].nameChar}
              setEditorData={dataUpdatableRight[0].setNameChar}
            />
          </div>
        </div>
        <div>
...
export default ExecutiveTemplate4;
